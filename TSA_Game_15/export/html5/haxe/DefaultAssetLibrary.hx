...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/images/imagebases.txt", __ASSET__assets_images_imagebases_txt);
		type.set ("assets/images/imagebases.txt", AssetType.TEXT);
...
@:file("assets/images/imagebases.txt") class __ASSET__assets_images_imagebases_txt extends lime.utils.ByteArray {}
...
@:bitmap("assets/images/tree3.png") class __ASSET__assets_images_tree3_png extends lime.graphics.Image {}
